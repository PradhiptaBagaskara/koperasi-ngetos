        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <a href="<?php echo base_url(); ?>/admin/PembiayaanController/tambahPembiayaan/<?php echo $this->uri->segment(4); ?>">
                        ...
                        <tbody>
                            <?php foreach ($record as $s) {?>
                                <tr>
                                    ...
                                    -- LUNAS --
                                    <?php else :?>
                                        <a href="<?php echo base_url(); ?>/admin/AngsuranPembiayaanController/index/<?php echo $s->id_pembiayaan; ?>/<?php echo $this->uri->segment(4); ?>">
