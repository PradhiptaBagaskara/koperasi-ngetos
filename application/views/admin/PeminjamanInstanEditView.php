        ...
        <div id="page-wrapper">
            ...
            <p></p>
                <ol class="breadcrumb">
                    ...
                    <li><a href="<?php echo base_url(); ?>/admin/PeminjamanInstanController/index/<?php echo $this->uri->segment(5); ?>">Data Peminjaman Instan</a></li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <form method="post" action="<?php echo base_url(); ?>/admin/PeminjamanInstanController/updatePeminjamanInstan/<?php echo $this->uri->segment(4); ?>/<?php echo $this->uri->segment(5); ?>">
                        ...
                        <a href="<?php echo base_url(); ?>/admin/PeminjamanInstanController/index/<?php echo $this->uri->segment(5); ?>">
