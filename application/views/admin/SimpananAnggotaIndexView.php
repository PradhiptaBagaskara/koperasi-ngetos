        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <a href="<?php echo base_url(); ?>/admin/SimpananAnggotaController/tambahSimpananAnggota/<?php echo $this->uri->segment(4); ?>">
                        <button type="button" class="btn btn-primary">
                            Tambah Simpanan Anggota
                        </button>
                    </a>
<!-- 
                    <a href="<?php echo base_url(); ?>/admin/SimpananAnggotaController/tambahSimpananAnggotaPengambilan/<?php echo $this->uri->segment(4); ?>">
