        ...
        <div id="page-wrapper">
            <div class="row">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="<?php echo base_url(); ?>/admin/PeminjamanInstanController/index/<?php echo $this->uri->segment(4); ?>">Data Peminjaman Instan</a></li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <form method="post" action="<?php echo base_url(); ?>/admin/PeminjamanInstanController/simpanPeminjamanInstan/<?php echo $this->uri->segment(4); ?>">
                        ...
                        <a href="<?php echo base_url(); ?>/admin/PeminjamanInstanController/index/<?php echo $this->uri->segment(4); ?>">
