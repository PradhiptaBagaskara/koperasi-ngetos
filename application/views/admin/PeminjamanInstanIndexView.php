        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <a href="<?php echo base_url(); ?>/admin/PeminjamanInstanController/tambahPeminjamanInstan/<?php echo $this->uri->segment(4); ?>">
                            ...
                            <?php foreach ($record as $s) {?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <?php if ($s->status == 0) {?>
                                            <a href="<?php echo base_url(); ?>/admin/PeminjamanInstanController/editPeminjamanInstan/<?php echo $s->id_peminjaman_instan; ?>/<?php echo $this->uri->segment(4); ?>">
