                    ...
                    <table id="dataUser" class="table table-hover table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">Catatan Peminjaman</th>
                            ...
                            <?php foreach ($pembiayaan as $s) {?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="<?php echo base_url(); ?>/admin/AngsuranPembiayaanController/indexUser/<?php echo $s->id_pembiayaan; ?>">
