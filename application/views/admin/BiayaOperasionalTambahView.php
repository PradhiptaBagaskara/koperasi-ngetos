        ...
        <div id="page-wrapper">
            ...
            <p></p>
                <ol class="breadcrumb">
                    ...
                    <li><a href="<?php echo base_url(); ?>/admin/BiayaOperasionalController/index">Biaya Operasional</a></li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <form method="post" action="<?php echo base_url(); ?>/admin/BiayaOperasionalController/simpanBiayaOperasional">
                        ...
                        <a href="<?php echo base_url(); ?>/admin/BiayaOperasionalController/index">
