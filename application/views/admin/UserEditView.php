        ...
        <div id="page-wrapper">
            ...
            <p></p>
                <ol class="breadcrumb">
                    ...
                    <li><a href="<?php echo base_url(); ?>/UserController/index">Data User</a></li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <form method="post" action="<?php echo base_url(); ?>/UserController/updateUser">
                        ...
                        <input type="hidden" name="role" value="<?php echo $s->role; ?>">
                        <!-- <div class="form-group">
