        ...
        <div id="page-wrapper">
            ...
            <p></p>
                <ol class="breadcrumb">
                    ...
                    <li><a href="<?php echo base_url(); ?>/admin/SimpananAnggotaController/index/<?php echo $this->uri->segment(4); ?>">Data Simpanan Anggota</a></li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <form method="post" action="<?php echo base_url(); ?>/admin/SimpananAnggotaController/simpanSimpananAnggota/<?php echo $this->uri->segment(4); ?>">
                        ...
                        <div class="form-group">
                            <label for="simpanan_pokok">Simpanan</label>
                            <input name="simpanan_pokok" type="text" class="form-control angka" id="simpanan_pokok" placeholder="masukkan Simpanan Anggota" required>
                        </div>
                        ...
                        <a href="<?php echo base_url(); ?>/admin/SimpananAnggotaController/index/<?php echo $this->uri->segment(4); ?>">
