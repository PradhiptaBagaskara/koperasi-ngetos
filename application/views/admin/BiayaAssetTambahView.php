        ...
        <div id="page-wrapper">
            ...
            <p></p>
                <ol class="breadcrumb">
                    ...
                    <li><a href="<?php echo base_url(); ?>/admin/BiayaAssetController/index"">Biaya Asset</a></li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <form method="post" action="<?php echo base_url(); ?>/admin/BiayaAssetController/simpanBiayaAsset">
                        ...
                        <a href="<?php echo base_url(); ?>/admin/BiayaAssetController/index">
